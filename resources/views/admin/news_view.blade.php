		...
		<form action="{{url('News-Update')}}" method="POST" enctype='multipart/form-data'>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="modal-title"><i class="fa fa-lock pr5"></i> News Update</div>
				</div>
...
<div id="content">
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel">
				<div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> News View </span> </div>
					...
					<table class="table table-striped table-bordered table-hover" id="datatable">
						<thead>
							<tr>
								...
								<th class="visible-lg">Discription</th>
							...
							<tr>
								...
								<td class="hidden-xs text-center">
									<div class="btn-group">
										...
										<a href="{{url('News-delete/'.$key->id) }}" title="Delete" class="btn bg-red3 btn-gradient btn-sm"> <span class="glyphicon glyphicon-trash"></span> </a>
									</div>
								</td>
