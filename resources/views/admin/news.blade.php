...
<div id="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{url('News-Insert-Process')}}" method="POST" enctype='multipart/form-data'>
				@csrf
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form class="cmxform" id="altForm" method="get">
							...
							<div class="form-group">
								...
								<input id="name" name="short_discription" type="text" class="form-control" placeholder="Enter Short Description" required />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input  name="news_image" type="file" class="form-control" placeholder="Enter Slider Title" required />
							</div>
